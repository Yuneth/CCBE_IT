...
<v-container>
    ...
    <div class="center-container">
        <v-row>
            <v-col cols="12" sm="6" class="mt-1">
                <v-img data-aos="zoom-out" data-aos-duration="2000" src="https://ik.imagekit.io/u3wbiya66/PXL_20250128_092657658-EDIT.jpg?updatedAt=1738392311029" align="center" elevation="23"></v-img>
            </v-col>
            <v-col cols="12" sm="6">
    ...
    <div class="center-container">
        <v-row>
            ...
            <v-col cols="12" sm="6">
                <v-img data-aos="zoom-out" data-aos-duration="2000" src="https://ik.imagekit.io/u3wbiya66/2024_11_07_15_33_IMG_8396.jpg?updatedAt=1737709328196" align="center" class="mt-3" elevation="23"></v-img>
            </v-col>
        </v-row>
    </div>
    <br>
