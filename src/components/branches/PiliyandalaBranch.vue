<template>
  <div class="piliyandala-branch-page">
    <NavBar></NavBar>
          ...
          <v-col cols="12" md="8" lg="6" class="branch-card mt-3">
            <div class="branch-info">
              <p class="contact-item">
                ...
                No: 119 ,Moratuwa Road,Piliyandala,10300
              </p>
              <p class="contact-item">
              ...
              <p class="contact-item">
                ...
                <a href="tel:0112180008" class="contact-link">011 2 180 008</a>
              </p>
              <p class="contact-item">
                <v-icon class="contact-icon">mdi-email</v-icon>
                <a href="mailto:piliyandalaccbe@gmail.com" class="contact-link">piliyandalaccbe@gmail.com</a>
              </p>
              ...
              <a href="https://wa.me/+94705834666?text=Hello%20Piliyandala%20Branch" target="_blank" class="whatsapp-button">
  ...
  data() {
    return {
      contentItems: [{
        ...
        subtitle: "Explore Piliyandala Branch in 360",
        description: "Immerse yourself in a virtual tour of our vibrant learning spaces at the Piliyandala Branch.",
      }],
      images: [
        {
