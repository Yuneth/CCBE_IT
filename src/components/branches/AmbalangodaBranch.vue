<template>
  <div class="ambalangoda-branch-page">
    <NavBar></NavBar>
          ...
          <v-col cols="12" md="8" lg="6" class="branch-card mt-3">
            <div class="branch-info">
              ...
              <p class="contact-item">
                ...
                <a href="tel:091 2 252 452" class="contact-link">091 2 252 452</a>
              </p>
              <p class="contact-item">
                <v-icon class="contact-icon">mdi-email</v-icon>
                <a href="mailto:ambalangodaccbe@gmail.com" class="contact-link">ambalangodaccbe@gmail.com</a>
              </p>
