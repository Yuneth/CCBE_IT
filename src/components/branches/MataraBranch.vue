<template>
  <div class="matara-branch-page">
    <NavBar></NavBar>
    <v-container class="main-container">
      <!-- Header Section -->
      <section class="header-section">
        <h1 class="page-title" data-aos="fade-up" data-aos-duration="3000">
          Welcome to <span class="highlight">Matara College</span>
        </h1>
      </section>
          ...
          <v-col cols="12" md="8" lg="6" class="branch-card mt-3">
            <div class="branch-info">
              ...
              <p class="contact-item">
                ...
                <a href="tel:041 20 50 200" class="contact-link">041 20 50 200</a>
              </p>
              <p class="contact-item">
                <v-icon class="contact-icon">mdi-email</v-icon>
                <a href="mailto:mataraccbe@gmail.com" class="contact-link">mataraccbe@gmail.com</a>
              </p>
              ...
              <a href="https://wa.me/+94707997506?text=Hello%20Branch%201" target="_blank" class="whatsapp-button">
...
export default {
  ...
  data() {
    return {
      contentItems: [{
        ...
        subtitle: "Explore Matara Branch in 360",
        description: "Immerse yourself in a virtual tour of our vibrant learning spaces at the Matara Branch.",
      }],
      images: [{
  ...
  methods: {
    openGoogleMaps() {
      window.open('https://www.google.com/maps/place/Cambridge+College+of+British+English+-+Matara+Branch/@5.9462457,80.5332676,17z/data=!3m1!4b1!4m6!3m5!1s0x3ae13fc54e40cd0f:0x4f157d7ce1ff2d01!8m2!3d5.9462457!4d80.5358425!16s%2Fg%2F11kk73mbnd?entry=ttu&g_ep=EgoyMDI5MDEyMi4wIKXMDSoASAFQAw%3D%3D', '_blank');
    },
  },
};
</script>
